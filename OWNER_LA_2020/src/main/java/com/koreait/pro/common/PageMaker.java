...
public class PageMaker {
	...
	public static String getPageView2(String path, int m_No, int page, int recordPerPage, int totalRecord) {
		...
		if ( beginPageOfBlock < pagePerBlock ) {
			...
			sb.append("<a href='" + path + "?m_No=" + m_No + "&page=" + (beginPageOfBlock - 1) + "'>◀</a>&nbsp;&nbsp;");
		}
		...
		for ( int p = beginPageOfBlock; p <= endPageOfBlock; p++ ) {
			if ( p == page ) {
				...
				sb.append("<a href='" + path +  "?m_No=" + m_No + "&page=" + p + "'>" + p + "</a>&nbsp;&nbsp;");
			}
		}
		...
		if ( endPageOfBlock == totalPage ) {
			...
			sb.append("<a href='" + path +  "?m_No=" + m_No + "&page=" + (endPageOfBlock + 1) + "'>▶</a>");
		}

		return sb.toString();

	}
	public static String getPageView3(String path, String m_Id, int page, int recordPerPage, int totalRecord) {
		...
		if ( beginPageOfBlock < pagePerBlock ) {
			...
			sb.append("<a href='" + path + "?m_Id=" + m_Id + "&page=" + (beginPageOfBlock - 1) + "'>◀</a>&nbsp;&nbsp;");
		}
		...
		for ( int p = beginPageOfBlock; p <= endPageOfBlock; p++ ) {
			if ( p == page ) {
				...
				sb.append("<a href='" + path +  "?m_Id=" + m_Id + "&page=" + p + "'>" + p + "</a>&nbsp;&nbsp;");
			}
		}
		...
		if ( endPageOfBlock == totalPage ) {
			...
			sb.append("<a href='" + path +  "?m_Id=" + m_Id + "&page=" + (endPageOfBlock + 1) + "'>▶</a>");
		}
	...
	public static String getPageView4(String path, String p_Cartegory, int page, int recordPerPage, int totalRecord) {
		...
		if ( beginPageOfBlock < pagePerBlock ) {
			...
			sb.append("<a href='" + path + "?p_Cartegory=" + p_Cartegory + "&page=" + (beginPageOfBlock - 1) + "'>◀</a>&nbsp;&nbsp;");
		}
		...
		for ( int p = beginPageOfBlock; p <= endPageOfBlock; p++ ) {
			if ( p == page ) {
				...
				sb.append("<a href='" + path +  "?p_Cartegory=" + p_Cartegory + "&page=" + p + "'>" + p + "</a>&nbsp;&nbsp;");
			}
		}
		...
		if ( endPageOfBlock == totalPage ) {
			...
			sb.append("<a href='" + path +  "?p_Cartegory=" + p_Cartegory + "&page=" + (endPageOfBlock + 1) + "'>▶</a>");
		}

		return sb.toString();

	}
	public static String getPageView5(String path, int p_State, int page, int recordPerPage, int totalRecord) {
		...
		if ( beginPageOfBlock < pagePerBlock ) {
			...
			sb.append("<a href='" + path + "?p_State=" + p_State + "&page=" + (beginPageOfBlock - 1) + "'>◀</a>&nbsp;&nbsp;");
		}
		...
		for ( int p = beginPageOfBlock; p <= endPageOfBlock; p++ ) {
			if ( p == page ) {
				...
				sb.append("<a href='" + path +  "?p_State=" + p_State + "&page=" + p + "'>" + p + "</a>&nbsp;&nbsp;");
			}
		}
		...
		if ( endPageOfBlock == totalPage ) {
			...
			sb.append("<a href='" + path +  "?p_State=" + p_State + "&page=" + (endPageOfBlock + 1) + "'>▶</a>");
		}
